...
srun apptainer exec ${container} \
    bash -c "export PYTHONPATH=/home/hmueller2/ibc_code/ibc_latent/public_analysis:\$PYTHONPATH && python /home/hmueller2/ibc_code/ibc_latent/public_analysis/ibc_public/run_fixed_effects_only.py $subject"
...
# run: sbatch /home/hmueller2/ibc_code/ibc_latent/public_analysis/ibc_public/run_fixed_effects_only_SLURM.sh