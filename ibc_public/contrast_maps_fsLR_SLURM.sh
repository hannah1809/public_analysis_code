...
#SBATCH --output=/ptmp/hmueller2/GLM_results_fsLR/logs/%A_%x.out
#SBATCH --error=/ptmp/hmueller2/GLM_results_fsLR/logs/%A_%x.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python /home/hmueller2/ibc_code/ibc_latent/public_analysis/ibc_public/contrast_maps_fsLR.py $subject