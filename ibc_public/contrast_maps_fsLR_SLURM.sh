...
srun apptainer exec ${container} \
    bash -c "export PYTHONPATH=/home/hmueller2/ibc_code/ibc_latent/public_analysis:\$PYTHONPATH && python /home/hmueller2/ibc_code/ibc_latent/public_analysis/ibc_public/contrast_maps_fsLR_merge.py $subject"
